...
HD_PWD='C:/Users/FoersterGame/Documents/GitHub/FPGAintro/0_1_HelloWorld/0_1_HelloWorld.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log HelloWorld.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source HelloWorld.tcl -notrace
