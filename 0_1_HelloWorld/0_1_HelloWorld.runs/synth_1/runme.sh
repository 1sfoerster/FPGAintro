...
HD_PWD='C:/Users/FoersterGame/Documents/GitHub/FPGAintro/0_1_HelloWorld/0_1_HelloWorld.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log HelloWorld.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source HelloWorld.tcl
