...
HD_PWD='C:/Users/FoersterGame/Documents/GitHub/FPGAintro/1_3_Non-blocking/1_3_Non-blocking.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Sequential_a.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Sequential_a.tcl
