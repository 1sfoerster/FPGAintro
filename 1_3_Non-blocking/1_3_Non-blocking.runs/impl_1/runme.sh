...
HD_PWD='C:/Users/FoersterGame/Documents/GitHub/FPGAintro/1_3_Non-blocking/1_3_Non-blocking.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Sequential_a.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Sequential_a.tcl -notrace
