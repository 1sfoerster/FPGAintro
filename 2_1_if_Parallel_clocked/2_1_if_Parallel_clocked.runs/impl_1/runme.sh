...
HD_PWD='C:/Users/FoersterGame/Documents/GitHub/FPGAintro/2_1_if_Parallel_clocked/2_1_if_Parallel_clocked.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log if_a.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source if_a.tcl -notrace
