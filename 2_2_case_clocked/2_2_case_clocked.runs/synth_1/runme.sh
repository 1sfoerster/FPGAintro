...
HD_PWD='C:/Users/FoersterGame/Documents/GitHub/FPGAintro/2_2_case_clocked/2_2_case_clocked.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log case_parallel.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source case_parallel.tcl
