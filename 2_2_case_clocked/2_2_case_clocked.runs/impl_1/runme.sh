...
HD_PWD='C:/Users/FoersterGame/Documents/GitHub/FPGAintro/2_2_case_clocked/2_2_case_clocked.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log case_parallel.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source case_parallel.tcl -notrace
