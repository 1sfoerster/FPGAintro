...
HD_PWD='C:/Users/FoersterGame/Documents/GitHub/FPGAintro/2_1_if_Sequential_clocked/2_1_if_Sequential_clocked.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log if_sequential.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source if_sequential.tcl -notrace
