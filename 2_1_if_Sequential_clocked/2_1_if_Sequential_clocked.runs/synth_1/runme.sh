...
HD_PWD='C:/Users/FoersterGame/Documents/GitHub/FPGAintro/2_1_if_Sequential_clocked/2_1_if_Sequential_clocked.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log if_sequential.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source if_sequential.tcl
