...
HD_PWD='C:/Users/FoersterGame/Documents/GitHub/FPGAintro/1_1_Parallel_c/1_1_Parallel_c.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Parallela.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Parallela.tcl -notrace
