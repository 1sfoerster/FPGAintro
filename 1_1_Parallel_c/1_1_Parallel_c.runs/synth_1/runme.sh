...
HD_PWD='C:/Users/FoersterGame/Documents/GitHub/FPGAintro/1_1_Parallel_c/1_1_Parallel_c.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Parallela.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Parallela.tcl
